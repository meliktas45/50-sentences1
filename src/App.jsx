        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#2C241B]/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-[#F9F4E8] border-2 border-[#2C241B] p-8 max-w-md w-full shadow-[8px_8px_0px_0px_rgba(192,86,54,1)] relative">
            ...
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              <a href="[https://www.buymeacoffee.com/50sentences](https://www.buymeacoffee.com/50sentences)" target="_blank" className="w-full py-4 bg-[#D4A03D] hover:bg-[#B8862D] text-[#2C241B] font-bold uppercase tracking-widest border-2 border-[#2C241B] shadow-[4px_4px_0px_0px_rgba(44,36,27,1)] active:translate-x-[2px] active:translate-y-[2px] flex items-center justify-center gap-2">
